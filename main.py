...
photologo = 'https://envs.sh/ajv.jpg'
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        "🎉Congrats! You are using 𝙐𝙄 𝘽𝙊𝙏𝙎:\n┣\n"
...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url=f"https://t.me/UIHASH")]])
...
async def txt_handler(bot: Client, m: Message):
    ...
    await m.reply_text(f"`✨𝙱𝚊𝚝𝚌𝚑 𝚂𝚞𝚖𝚖𝚊𝚛𝚢✨\n"
                       ...
                       f"✅𝚂𝚝𝚊𝚝𝚞𝚜 » 𝙲𝚘𝚖𝚙𝚕𝚎𝚝𝚎𝚍`")
    await m.reply_text("<pre><code>Downloaded By ⌈✨『𝙐𝙄 𝘽𝙊𝙏𝙎』✨⌋</code></pre>")
...
async def txt_handler(bot: Client, m: Message):
    ...
    try: 
        ...
        await m.reply_text(e)
    await m.reply_text("<pre><code>Converted By ⌈✨『𝙐𝙄 𝘽𝙊𝙏𝙎』✨⌋</code></pre>")
